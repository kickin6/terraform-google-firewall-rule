...
variable target_service_accounts {
  description = "A list of service accounts indicating sets of instances located in the network that may make network connections as specified in allow. List of strings."
  type        = "list"
  default     = []
}
